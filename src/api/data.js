...
const dataUrl = `https://campus.kits.tw/api/get/data/aaf55a77?date_filter=${today.getFullYear()}-${today.getMonth()+1}-${today.getDate()}+-+${today.getFullYear()}-${today.getMonth()+1}-${today.getDate()+1}`;
...
export default function getData() {
    ...
    // console.log(`Making POST request to ${dataUrl}`);
